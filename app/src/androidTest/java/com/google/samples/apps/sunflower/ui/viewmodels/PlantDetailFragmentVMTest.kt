...
@HiltAndroidTest
class PlantDetailFragmentVMTest {

    private lateinit var appDatabase: AppDatabase
    private lateinit var viewModel: PlantDetailFragmentVM
    ...
    fun setUp() {
        ...
        viewModel = PlantDetailFragmentVM(savedStateHandle, plantRepository, gardenPlantRepository)
    }
